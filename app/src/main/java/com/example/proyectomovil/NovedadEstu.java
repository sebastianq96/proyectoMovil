...
public class NovedadEstu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_novedad_estu);
        ...
        btnInsertar.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(!id_curso.getText().toString().trim().equalsIgnoreCase("")||
                    ...
                    new Insertar(NovedadEstu.this).execute();
                else
                    Toast.makeText(NovedadEstu.this, "Hay información por rellenar", Toast.LENGTH_LONG).show();
            }
